...
Pages nicht aus (`_src`, `_tests`, `_tools`, `_build.py`).
...
erfundenen Beispielkind.

Design, Plan und die Liste geheimer Prognose-Begriffe (`.secret-words`, für `test_home`) liegen
nicht in diesem öffentlichen Repo, sondern im privaten App-Repo unter `docs/website/`.
